...
<template>
    <AdminLayout>
        ...
        <Head title="Create Project Folder" />
        <!-- title -->
        ...
        <div class="bg-white shadow-sm px-4 py-3 rounded-sm">
            <form @submit.prevent="handleSubmit">
                ...
                <button type="submit"
                    class="mt-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg w-full sm:w-auto px-5 py-2.5 text-center">Create
                    project</button>
            </form>
